; ModuleID = 'cminus'
source_filename = "/home/flora/2024ustc-jianmu-compiler/tests/2-ir-gen/autogen/testcases/lv2/funcall_int_array.cminus"
...
label5:                                                ; preds = %label_entry, %label4
  %op6 = getelementptr i32, i32* %op2, i32 3
...
label3:                                                ; preds = %label_entry, %label2
  ...
  %op5 = getelementptr [10 x i32], [10 x i32]* %op0, i32 0
  %op6 = getelementptr [10 x i32], [10 x i32]* %op5, i32 0, i32 0
  call void @test(i32* %op6)
  ret void
}
