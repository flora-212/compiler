...
# br label %label17
	...
	b .main_label17
.main_label37:
# %op38 = phi i32 [ %op28, %label34 ], [ %op48, %label56 ]
# %op39 = phi i32 [ %op29, %label34 ], [ %op49, %label56 ]
# %op40 = phi i32 [ 0, %label34 ], [ %op57, %label56 ]
...
# br label %label27
	...
	b .main_label27
.main_label47:
# %op48 = phi i32 [ %op38, %label44 ], [ %op81, %label61 ]
# %op49 = phi i32 [ %op39, %label44 ], [ %op62, %label61 ]
# %op50 = phi i32 [ 0, %label44 ], [ %op82, %label61 ]
